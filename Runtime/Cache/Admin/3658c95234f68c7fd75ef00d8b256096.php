...
<body>
	...
	<form action="<?php echo U();?>" method="post" class="form-horizontal">
		...
		<div class="form-item">
			...
			<div class="controls">
				<input type="text" class="text input-small" name="user" value="<?php echo ((isset($info["user"]) && ($info["user"] !== ""))?($info["user"]):''); ?>">
			</div>
		</div>
		<div class="form-item">
		...
		<div class="form-item">
			<label class="item-label">地址<span class="check-tips">（问题发生地）</span></label>
			<div class="controls">
				<input type="text" class="text input-large" name="address" value="<?php echo ((isset($info["address"]) && ($info["address"] !== ""))?($info["address"]):''); ?>">
			</div>
		</div>
		<div class="form-item">
			<label class="item-label">问题<span class="check-tips">（或故障）</span></label>
			<div class="controls">
		...
		<div class="form-item">
			...
			<div class="controls">
				<select name="status">
					<option value="0" <?php if(($info["status"]) == "0"): ?>selected<?php endif; ?>>处理中</option>
					<option value="1" <?php if(($info["status"]) == "1"): ?>selected<?php endif; ?>>处理完成</option>
				</select>
			</div>
		</div>
		<!--<div class="form-item">
			...
			<div class="controls">
				<input type="text" name="create_time" class="text time" value="2017-08-10 11:11" placeholder="请选择时间">
			</div>
		</div>-->
		<div class="form-item">

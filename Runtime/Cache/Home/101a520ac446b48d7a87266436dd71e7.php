...
<div class="container">
    ...
    <div class="row">
        <div class="col-xs-3">
            <img src="./Public/Home/static/image/5.png" width="60" height="60" />
        </div>
        <div class="col-xs-9">
            <?php if(!empty($user)): if(is_array($user)): $i = 0; $__LIST__ = $user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$UcenterMember): $mod = ($i % 2 );++$i; echo ($UcenterMember["username"]); ?><br/>
            北大花园小区<br/>
            积分:<span class="text-danger">100</span><?php endforeach; endif; else: echo "" ;endif; endif; ?>
        </div>
    </div>
    <div class="blank"></div>
    ...
    <div>
        <ul class="list-group fuwuList">
            ...
            <li class="list-group-item"><a href="<?php echo U('profile');?>" class="text-danger"><span class="iconfont">&#xe607;</span>修改密码</a></li>
            <li class="list-group-item"><a href="<?php echo U('logout');?>" class="text-warning"><span class="iconfont">&#xe607;</span>退出登陆</a></li>
        </ul>
    </div>
</div>
